...
sperso1 = pygame.image.load("Viking1.gif").convert_alpha()
position_perso1 = sperso1.get_rect()

sperso2 = pygame.image.load("perso2.png").convert_alpha()
position_perso2 = sperso2.get_rect()

sperso3 = pygame.image.load("Athénien1.gif").convert_alpha()
position_perso3 = sperso3.get_rect()

sperso4 = pygame.image.load("Prêtresse1.gif").convert_alpha()
...
def eventperso1():
        ...
        if event.key == K_UP :
            if listperso1[2]>0 :
                position_perso1 = position_perso1.move(0,-150)
        ...
        if event.key == K_RIGHT:
            if listperso1[2]>0 :
                position_perso1 = position_perso1.move(150,0)
                listperso1[2]=listperso1[2]-1
        if event.key == K_LEFT:
              if listperso1[2]>0 :
                  position_perso1 = position_perso1.move(-150,0)
...
def eventperso2():
        ...
        if event.key == K_UP :
              if listperso2[2]>0 :
                 position_perso2 = position_perso2.move(0,-150)
        ...
        if event.key == K_RIGHT:
              if listperso2[2]>0 :
                 position_perso2 = position_perso2.move(150,0)
                 listperso2[2]=listperso2[2]-1
        if event.key == K_LEFT:
            if listperso2[2]>0 :
                position_perso2 = position_perso2.move(-150,0)
...
def eventperso3():
        ...
        if event.key == K_UP :
            if listperso3[2]>0 :
                position_perso3 = position_perso3.move(0,-150)
        ...
        if event.key == K_RIGHT:
            if listperso3[2]>0 :
                position_perso3 = position_perso3.move(150,0)
                listperso3[2]=listperso3[2]-1
        if event.key == K_LEFT:
            if listperso3[2]>0 :
                position_perso3 = position_perso3.move(-150,0)
...
def eventperso4():
        ...
        if event.key == K_UP :
            if listperso4[2]>0 :
                position_perso4 = position_perso4.move(0,-150)
        ...
        if event.key == K_RIGHT:
            if listperso4[2]>0 :
                position_perso4 = position_perso4.move(150,0)
                listperso4[2]=listperso4[2]-1
        if event.key == K_LEFT:
            if listperso4[2]>0 :
                position_perso4 = position_perso4.move(-150,0)
