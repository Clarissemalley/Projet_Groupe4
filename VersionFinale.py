...
def interface(a):   #affiche les statistiques du personnage joué, la vie des trois ennemis et place le curseur au dessus du personnage joué
    if a ==1 :
        ...
        statsbg2=font.render("PA: "+str(listperso1[2])+"/"+str(listperso1[3]),1, green)
    ...
    pvmechant1=font.render("Draugr PV: "+str(listmechant1[0])+"/"+str(listmechant1[1]),1, blue)
    pvmechant2=font.render("Satyre PV: "+str(listmechant2[0])+"/"+str(listmechant2[1]),1, yellow)
    pvmechant3=font.render("Kappa PV: "+str(listmechant3[0])+"/"+str(listmechant3[1]),1, green)
